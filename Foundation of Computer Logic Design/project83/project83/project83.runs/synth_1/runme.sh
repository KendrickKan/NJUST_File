...
HD_PWD='D:/project83/project83/project83.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project83.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project83.tcl
