...
HD_PWD='D:/project83/project83/project83.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project83.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project83.tcl -notrace
